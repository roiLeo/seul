...
module.exports = class statemine1636729191664 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "asset_balance" ("id" character varying NOT NULL, "balance" numeric NOT NULL, "status" character varying(9) NOT NULL, "wallet_id" character varying NOT NULL, "asset_id" character varying NOT NULL, CONSTRAINT "PK_7ffc793d0d7d680c10e4741f173" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_28677aac0e846935951db13307" ON "asset_balance" ("wallet_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "asset_balance" ADD CONSTRAINT "FK_28677aac0e846935951db133077" FOREIGN KEY ("wallet_id") REFERENCES "account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "asset_balance" DROP CONSTRAINT "FK_28677aac0e846935951db133077"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_28677aac0e846935951db13307"`);
