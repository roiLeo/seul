...
module.exports = class statemine1636614209218 {
    name = 'statemine1636614209218'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "asset" ("id" character varying NOT NULL, "name" text, "symbol" text, "freezer" text, "decimal" integer, "admin" text NOT NULL, "issuer" text, "min_balance" numeric NOT NULL, "status" character varying(9) NOT NULL, CONSTRAINT "PK_1209d107fe21482beaea51b745e" PRIMARY KEY ("id"))`);
