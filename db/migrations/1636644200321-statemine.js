...
module.exports = class statemine1636644200321 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "asset" ("id" character varying NOT NULL, "name" text, "symbol" text, "freezer" text, "decimal" integer, "owner" text NOT NULL, "issuer" text, "creator" text, "min_balance" numeric, "status" character varying(9) NOT NULL, "total_supply" numeric, CONSTRAINT "PK_1209d107fe21482beaea51b745e" PRIMARY KEY ("id"))`);
